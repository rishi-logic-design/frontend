...
const CreditNoteDetails = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await creditNoteService.getCreditNoteById(id);
  ...
  if (!data) return <div className="details-error">Credit Note not found.</div>;
        ...
        <div className="invoice-footer">
          ...
          <div className="summary-section">
            ...
            <div className="summary-row">
              ...
              <span>
                ₹{(data.taxTotal || data.gstTotal || 0).toLocaleString()}
              </span>
            </div>
