...
import "./purchaseDetailsReport.scss";
...
const PurchaseDetailsReport = () => {
  ...
  const fetchReport = useCallback(async () => {
    try {
      setLoading(true);
      const res = await reportService.getPurchaseDetailsReport({
        fromDate,
        toDate,
        search,
        page,
      ...
      toast.error(err?.message || "Failed to fetch Purchase Details Report");
    } finally {
      setLoading(false);
    }
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `purchase-details-report-${fromDate}-to-${toDate}.csv`;
    a.click();
  ...
  return (
    <div className="pdr-page">
      {/* ── Header ─────────────────────────────────────────── */}
      <header className="pdr-header">
        <div className="pdr-header__left">
          <button
            className="back-btn"
        ...
        <div className="pdr-header__right">
          ...
          <div className="pdr-table-wrap">
            {loading ? (
              <div className="pdr-loading">
                ...
                <span>Fetching purchase details…</span>
              </div>
            ) : (
