...
import "./productWiseSalesReport.scss";
...
const ProductWiseSalesReport = () => {
  ...
  const fetchReport = useCallback(async () => {
    try {
      setLoading(true);
      const res = await reportService.getProductWiseSalesReport({
        fromDate,
        toDate,
        search,
        page,
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `product-wise-sales-report-${fromDate}-to-${toDate}.csv`;
    a.click();
  ...
  return (
    <div className="pwsr-page">
      {/* ── Header ─────────────────────────────────────────── */}
      <header className="pwsr-header">
        <div className="pwsr-header__left">
          <button
            className="back-btn"
        ...
        <div className="pwsr-header__right">
      ...
      {/* ── Main Card ──────────────────────────────────────── */}
      <main className="pwsr-main">
        <div className="pwsr-card">
          {/* Controls bar */}
          <div className="pwsr-controls">
          ...
          {/* Table */}
          <div className="pwsr-table-wrap">
            {loading ? (
              <div className="pwsr-loading">
                <div className="spinner" />
                <span>Fetching report data…</span>
              </div>
            ) : (
              <table className="pwsr-table">
                <thead>
                  <tr>
                    <th>Serial No.</th>
                    <th>Product Name</th>
